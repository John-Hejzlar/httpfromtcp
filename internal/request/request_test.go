...
func TestRequestLineParse(t *testing.T) {
	...
	r, err = RequestFromReader(strings.NewReader("POST /resource HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.NoError(t, err)
	require.NotNil(t, r)
	...
	_, err = RequestFromReader(strings.NewReader("GET / FTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)
}
...
func TestRequestLineIncomplete(t *testing.T) {
	// Test: Good GET Request line
	reader := &chunkReader{
		data:            "GET / HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 3,
...
func TestRequestBodyParse(t *testing.T) {
	...
	// require.NoError(t, err)
	// require.NotNil(t, r)
	// assert.Equal(t, "Body data", string(r.Body))
}
